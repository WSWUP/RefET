...
def test_refet_daily_input_positions():
    etr = Daily(
        d_args['tmin'], d_args['tmax'], d_args['ea_asce'], d_args['rs'],
...
def test_refet_daily_etr():
    etr = Daily(
        tmin=d_args['tmin'], tmax=d_args['tmax'], ea=d_args['ea_asce'],
...
def test_refet_daily_method(method, expected):
    etr = Daily(
        tmin=d_args['tmin'], tmax=d_args['tmax'], ea=d_args['ea_'+method],
        rs=d_args['rs'], uz=d_args['uz'], zw=s_args['zw'],
        elev=s_args['elev'], lat=s_args['lat'], doy=d_args['doy'],
        method=method).etr()
...
def test_refet_daily_tmin_f():
    etr = Daily(
        ...
        ea=d_args['ea_asce'], rs=d_args['rs'], uz=d_args['uz'], zw=s_args['zw'],
        elev=s_args['elev'], lat=s_args['lat'], doy=d_args['doy'],
...
def test_refet_daily_ea_pa():
    etr = Daily(
        tmin=d_args['tmin'], tmax=d_args['tmax'], ea=d_args['ea_asce'] * 1000,
        rs=d_args['rs'], uz=d_args['uz'], zw=s_args['zw'],
        elev=s_args['elev'], lat=s_args['lat'], doy=d_args['doy'],
